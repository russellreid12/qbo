...
class QBOtalk(object):
  def __init__(self, controller=None):
    ...
    cfg_sample_rate = _config_int_optional(self.config, "microphoneSampleRate") or 16000
  ...
  def downsampleWave_2(self, src, dst, inrate, outrate, inchannels, outchannels):
    ...
    try:
      # Note: audioop is often used here, but verify imports if dependency issues arise.
      import audioop
