...
new (function () {
    ...
    ext.youtube = function (url, callback) {
        connection.send('-c youtube -y ' + url);
        callback();
    };
    ...
    var descriptor = {
        blocks: [
            ['w', 'Connect ip: %s port: %n', 'connect', 'qbo.local', 51717],
            ...
            ['w', 'Youtube URL %s', 'youtube', 'https://www.youtube.com/watch?v=dQw4w9WgXcQ'],
        ],
        menus: {
